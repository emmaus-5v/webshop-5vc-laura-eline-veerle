...
insert into products (name, description, code, price) values ('andere schoen', '686928463-6', 14);
...
insert into products (name, description, code, price) values ('Vans bold NI cheetah - sneakers laag', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.

Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', '492662523-7', 59.99);