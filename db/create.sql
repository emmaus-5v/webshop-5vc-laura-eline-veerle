...
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('RS-FAST TECH UNISEX - laag Puma', 'Dit is de Fast TECH schoen van Puma. Dit is een vervolg op de RS selectie. Door de geavanceerde demping van Puma voelt het bij deze schoenen alsof je op zachte wolkjes loopt!', '816905633-0', 109.99, 3, 1);
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('X-RAY 2 Square - laag Puma', 'Deze kleurijke schoenen van Puma zijn de nieuwe rage. Met deze X-RAY 2 SQUARE schoenen zal je niet onherkend blijven. De geweldige demping in de zool geeft je een loopervaring om nooit te vergeten!', '077030122-3', 59.99, 3, 1);
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('Nike Air Force 1 First Use - laag Nike', 'Deze First Use Nike Air Force schoenen zijn niet zomaar schoenen, dit zijn de limited edition schoenen voor het 50-jarige jubileum van Nike. Wie wil deze schoenen nou niet!', '445924201-X', 109.99, 1, 1);
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('Nike Air Force 1 Shadow - laag Nike', 'Deze zomerse kleuren moeten je wel opvrolijken. Ga met een frisse look de zomer in met deze nieuwe Nike Air Force Shadow schoenen.', '693155505-7', 109.95, 1, 1);
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('Adidas Rivalry - Low Premium', 'Door het rustige groen en de zachte roze kleur is deze schoen perfect voor mensen die van kalmte houden. Keep calm en koop deze schoenen!', '492662523-7', 99.99, 1, 1);
...
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('Blazer Low 77 VNTG - laag Nike', 'Deze blazers zijn helemaal in nu en zijn net iets anders dan de meest bekende blazers, want deze zijn laag. Het zijn witte schoenen met een zwarte swoosh, dus ze passen echt bij elke outfit!', '686928463-6', 89.99, 3, 1);
...
insert into products (name, description, code, price, geslacht_id, hoogte_id) values ('OZWEEGO - laag Adidas Originals', 'Deze nieuwe Adidas schoenen zien er super leuk uit. Je doet ze super makkelijk aan en ze lopen ook nog eens heerlijk!', '583978399-5', 99.95, 3, 1);
